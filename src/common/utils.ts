...
export function generateRegisterTicketMail(user: string, company: string, link: string) {
  const html = `<p>Se ha registrado un nuevo ticket por parte del usuario <strong>${user}</strong> de la empresa <strong>${company}</strong>.</p> </br></br> <p>Para realizar acciones, ingresar al siguiente enlace <a href=${link} target="_blank">Haz click aquí</a></p> </br></br> <img src="https://vauxeythnbsssxnhvntg.supabase.co/storage/v1/object/public/media/mail/mail-footer.jpg?t=2023-12-15T16%3A01%3A39.800Z">`
...
export function generateAssignTicketMail(idTechnician: string | null, scheduledAppointmentDate: Date, ScheduledAppointmentTime: Date, company: string, address: string, floor: string, link: string) {
  const html = `<p>Se ha asignado ${idTechnician == null
    ...
    }</strong>. </br></br> <p>Para realizar acciones, ingresar al siguiente enlace <a href=${link} target="_blank">Haz click aquí</a></p> </br></br> <img src="https://vauxeythnbsssxnhvntg.supabase.co/storage/v1/object/public/media/mail/mail-footer.jpg?t=2023-12-15T16%3A01%3A39.800Z">`
...
export function generateMailFacturable(user: string, company: string) {
  const html = `<p>Se atendió el ticket del usuario <strong>${user}</strong> en la empresa <strong>${company}</strong>.</p> </br></br> <p>Para realizar acciones, ingresar al siguiente enlace <a href="https://qa.qualitysumprint.com" target="_blank">Haz click aquí</a></p> </br></br> <img src="https://vauxeythnbsssxnhvntg.supabase.co/storage/v1/object/public/media/mail/mail-footer.jpg?t=2023-12-15T16%3A01%3A39.800Z" alt="">`
